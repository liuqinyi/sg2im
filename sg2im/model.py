...
class Sg2ImModel(nn.Module):
    ...
    Load the local file *.pt, include model and weight.

    Arg:
        vocab: scene_graph objects and relationship.
        ...
        gconv_pooling:
        gconv_num_layers:
                A single layer of scene graph convolution, output dim of scene graph conv

        refinement_dims:
        normalization:
        activation:
        mask_size: generate from object feature
        mlp_normalization:
        layout_noise_dim: input noise
